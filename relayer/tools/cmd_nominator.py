...
from relayer.tools.utils import display_receipt_status, get_option_from_console, \
    get_typed_item_from_console, Manager, RelayerWithVersion
        ...
        if cmd == SupportedNominatorCmd.FETCH_HEALTHY_AUTHORITIES:
            ...
            for rwv in healthy_relayers:
                candidate_state = nominator.world_call(
                    ChainIndex.BIFROST, "authority", "candidate_state", [rwv.relayer.hex()])
