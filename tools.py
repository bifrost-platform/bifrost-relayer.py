...
from relayer.tools.cmd_recharger import recharger_forever
from relayer.tools.cmd_user import user_cmd
from relayer.tools.utils import get_option_from_console

if __name__ == "__main__":

    tool_names = ["User", "Operator", "Nominator", "Admin", "Recharger", "LoadTester"]
    ...
    while True:
        ...
        if selected_tools == "Recharger":
            recharger_forever(project_root_path)
